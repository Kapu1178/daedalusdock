...
/datum/admin_help/proc/MessageNoRecipient(msg, urgent = FALSE)
	...
	for(var/client/X in GLOB.admins)
		if(X.prefs.toggles & SOUND_ADMINHELP)
			SEND_SOUND(X, sound('goon/sounds/adminhelp.ogg', channel = SSsounds.random_available_channel()))
...
/datum/admin_help/proc/Reject(key_name = key_name_admin(usr))
	...
	if(initiator)
		...
		SEND_SOUND(initiator, sound('goon/sounds/adminhelp.ogg', channel = SSsounds.random_available_channel()))
