...
/obj/structure/bookcase/examine(mob/user)
	. = ..()
	if(!anchored)
		. += span_info("The <b>bolts</b> on the bottom are unsecured.")
	else
		. += span_info("It's secured in place with <b>bolts</b>.")
	switch(state)
		if(BOOKCASE_UNANCHORED)
			. += span_info("There's a <b>small crack</b> visible on the back panel.")
		if(BOOKCASE_ANCHORED)
			. += span_info("There's space inside for a wooden shelf.")
		if(BOOKCASE_FINISHED)
			. += span_info("There's a <b>small crack</b> visible on the shelf.")
