...
/obj/machinery/dna_scannernew/examine(mob/user)
	...
	if(in_range(user, src) || isobserver(user))
		. += span_info("The status display reads: Radiation pulse accuracy increased by factor <b>[precision_coeff**2]</b>.<br>Radiation pulse damage decreased by factor <b>[damage_coeff**2]</b>.")
