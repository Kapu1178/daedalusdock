...
/obj/machinery/door/poddoor/examine(mob/user)
	...
	if(panel_open)
		if(deconstruction == BLASTDOOR_FINISHED)
			. += span_info("The maintenance panel is opened and the electronics could be <b>pried</b> out.")
		else if(deconstruction == BLASTDOOR_NEEDS_ELECTRONICS)
			. += span_info("The <i>electronics</i> are missing and there are some <b>wires</b> sticking out.")
		else if(deconstruction == BLASTDOOR_NEEDS_WIRES)
			. += span_info("The <i>wires</i> have been removed and it's ready to be <b>sliced apart</b>.")
